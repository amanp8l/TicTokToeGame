 ...
 * @author Aman Patel
 */
public class TicTocToeFrame extends javax.swing.JFrame {

    /**
     * Creates new form TicTocToeFrame
     */
    ...
    private void initComponents() {
        ...
        scoreX.setText("--------");
        scoreX.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                scoreXAncestorAdded(evt);
            }
            public void ancestorMoved(javax.swing.event.AncestorEvent evt) {
            }
            public void ancestorRemoved(javax.swing.event.AncestorEvent evt) {
                scoreXAncestorRemoved(evt);
            }
        });
        ...
        displayTurn.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(10, 10, 10)
                        .addComponent(displayTurn, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void xTurn(JButton btn){
        ...
        {
            xCount++;
            scoreX.setText(Integer.toString(oCount));
            scoreO.setText(Integer.toString(xCount));
            JFrame xWin=new JFrame("GAME OVER!");
            JOptionPane.showMessageDialog(xWin, "Player X has won the match!", 
                "Game Over!", JOptionPane.PLAIN_MESSAGE);
    ...
    private void oTurn(JButton btn){
        ...
        if(checkWin("O")){
            ...
            scoreO.setText(Integer.toString(xCount));
            JFrame oWin=new JFrame("GAME OVER!");
            JOptionPane.showMessageDialog(oWin, "Player O has won the match!", 
                "Game Over!", JOptionPane.PLAIN_MESSAGE);
        }
        changeTurn();
    }
    ...
    private void scoreXAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_scoreXAncestorAdded
        // TODO add your handling code here:
    }//GEN-LAST:event_scoreXAncestorAdded

    private void scoreXAncestorRemoved(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_scoreXAncestorRemoved
        // TODO add your handling code here:
    }//GEN-LAST:event_scoreXAncestorRemoved
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TicTocToeFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TicTocToeFrame().setVisible(true);
            }
        });
    }
